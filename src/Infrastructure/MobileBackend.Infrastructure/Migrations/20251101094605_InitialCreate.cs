        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermissionBit = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    RedValue = table.Column<int>(type: "integer", nullable: false),
                    GreenValue = table.Column<int>(type: "integer", nullable: false),
                    BlueValue = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Colors_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermissionsBitmask = table.Column<long>(type: "bigint", nullable: false, defaultValue: 0L),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false, defaultValue: "Successful"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderItems_Users_RefundedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Colors_RedValue_GreenValue_BlueValue",
                table: "Colors",
                columns: new[] { "RedValue", "GreenValue", "BlueValue" },
                unique: true,
                filter: "\"IsDeleted\" = false");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Permissions_PermissionBit",
                table: "Permissions",
                column: "PermissionBit",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_IsEnabled_IsApproved",
                table: "Users",
                columns: new[] { "IsEnabled", "IsApproved" },
                filter: "\"IsDeleted\" = false");
