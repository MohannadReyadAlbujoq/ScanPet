...
namespace MobileBackend.Infrastructure.Migrations
{
    ...
    [Migration("20260409062020_AddDefaultInventoryToUser")]
    partial class AddDefaultInventoryToUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MobileBackend.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<Guid?>("DefaultInventoryId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MobileBackend.Domain.Entities.User", b =>
                {
                    ...
                    b.HasOne("MobileBackend.Domain.Entities.Inventory", "DefaultInventory")
                        .WithMany()
                        .HasForeignKey("DefaultInventoryId")
